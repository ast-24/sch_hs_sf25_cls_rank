...
import type { Igniter_ListenerT } from "../igniter/igniter.d";
import type { CxlCtxCI, CxlCtx_CancelResT } from "./cxlctx.d";
import { yieldThread } from "../utils";

export type CxlCtxC_VialT = {
...
export class CxlCtxC implements CxlCtxCI {
    protected readonly _vial: CxlCtxC_VialT;
    protected _parent: CxlCtxC | null;
    protected _children: Set<CxlCtxC> = new Set();
    protected _onCancel: IgniterC<void, void>;
    protected _canceled: boolean = false;
    protected _cancelAsyncRes: SpaAsyncResC<CxlCtx_CancelResT> | null = null;
    protected _deadlineTimer: ReturnType<typeof setTimeout> | null = null;
