...
import { updateRankingCache } from './ranking_cache.mjs';

export async function updateUserScoreCache(tidbCl, userDbId, tgtRoundIds = []) {
    ...
    await updateRankingCache(tidbCl, updateTgt);
}
